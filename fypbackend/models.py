...
class WeeklyGoals(models.Model):
    ...
    topics_to_be_covered = models.ManyToManyField(Chapter, related_name='planned_in_weekly_goals', blank=True)
    topics_covered = models.ManyToManyField(Chapter, related_name='covered_in_weekly_goals', blank=True)
