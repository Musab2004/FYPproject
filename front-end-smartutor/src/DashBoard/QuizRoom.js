...
>
  ...
  <Form.Control as="select" multiple onChange={(e) => setChapter(Array.from(e.target.selectedOptions, option => option.value))}>
...
<Form.Group controlId="formTopic">
  ...
  <Form.Control as="select" multiple onChange={(e) => setTopic(Array.from(e.target.selectedOptions, option => option.value))}>
