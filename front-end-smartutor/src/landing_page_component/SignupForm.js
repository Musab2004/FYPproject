...
const SignupForm = ({ show, setShow }) => {
	...
	const handleCountryChange = (selectedOption) => {
		...
		const cities =
			countries.find((country) => country.value === selectedOption.value)?.cities || [];
							...
							<div>
								<Form.Group controlId="country" className="mb-3">
									...
									<Select
										...
										]} // Replace with your country options
								...
								{selectedCountry && (
									<Form.Group controlId="city" className="mb-3">
										...
										<Select
											...
											]} // Replace with your city options based on the selected country
