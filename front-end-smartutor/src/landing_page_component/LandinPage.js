...
function App() {
	...
	return (
		<div>
			...
			<Container
				fluid
				style={{ marginTop: "3%", width: "100%", height: "600px", backgroundColor: "#e1efff" }}
			>
				<div style={{ position: "relative" }}>
					...
					>
						<div style={{ marginLeft: "3%", marginTop: "5%", width: "50%", color: "#1f5692" }}>
							...
							<Button
								className="m-2"
								style={{ background: "white", backgroundColor: "#f66b1d", borderColor: "#f66b1d" }}
							>
			...
			>
				...
				<div className="right-container" style={{ marginTop: "0%" }}>
					<div
						...
						style={{ textAlign: "center", marginLeft: "0%", width: "60%", marginLeft: "20%" }}
					>
						<br />
						<h2
							style={{ fontSize: "44px", fontWeight: "bold", fontFamily: "roca", color: "#1f5692" }}
						>
